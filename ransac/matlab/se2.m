...
% 
ssm(1)*u(3)*T(1:2,1:2)
-ssm(1)*u(1:2)+ssm(1)*u(3)*T(1:2,3)
dt = 1e-5;
g2 = g1*expm(wedge(u));
g2d1 = g1*expm(wedge(u+d1*dt));
g2d2 = g1*expm(wedge(u+d2*dt));
g2d3 = g1*expm(wedge(u+d3*dt));

[ev1, eu1] = ominus(g2,u,g2d1,u+d1*dt);
ev1 = ev1/dt;
eu1 = eu1/dt;

[ev2, eu2] = ominus(g2,u,g2d2,u+d2*dt);
ev2 = ev2/dt;
eu2 = eu2/dt;

[ev3, eu3] = ominus(g2,u,g2d3,u+d3*dt);
ev3 = ev3/dt;
eu3 = eu3/dt;
