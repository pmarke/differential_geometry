...
\end{align}
\end{subequations} This form is similar to the one found in \cite{SjÃžberg2019},
...
cumbersome if not impossible to derive, thus we will use the system
...
$y_{k}\in N$ is the output and $N$ is a Lie group, $h:G\to N$ is
the observation model, and $v_{k}$ is measurement noise sampled from
a zero-mean, white-noise, Gaussian distribution with covariance $R$.
