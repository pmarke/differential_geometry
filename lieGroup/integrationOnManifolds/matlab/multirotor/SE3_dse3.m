classdef SE3_dse3 < handle
    ...
    methods(Static)
        ...
        function v_new = CO_Ad_SE3_se3(g,v)
            ...
            R2 = g(1:3,1:3);
            t2 = g(1:3,4);
%             M = [R2' -R2'*SE3_dse3.SO3_wedge(t2);zeros(3,3), R2'];
        M = [R2' zeros(3,3); -R2'*SE3_dse3.SO3_wedge(t2), R2'];
            V = M*SE3_dse3.SE3_vee(v);
            
%             g_inv = [R2' -R2'*t2;zeros(1,3), 1];
            
            
            v_new = SE3_dse3.SE3_wedge(V);
%             v_new = g_inv*v*g;
        ...
        function W_vee = SE3_vee(W_wedge)
            ...
            omega_vee = SE3_dse3.SO3_vee(omega);
            rho = W_wedge(1:3,4);
        ...
        function W_wedge = SE3_wedge(W_vee)
           W_wedge=[SE3_dse3.SO3_wedge(W_vee(4:6)),W_vee(1:3);zeros(1,4)]; 
        end
        
        % se3 Matrix CO adjoint
        % v is the 4x4 matrix
        % m is the 6x6 matrix representation
        function m = se3_m_co_ad(v)
            
            
            m = SE3_dse3.se3_m_ad(v)';
        end
        ...
        function m = se3_m_ad(v)
            ...
            m = [omega, SE3_dse3.SO3_wedge(rho);zeros(3,3), omega];
        end
...
%             end
    ...
    methods
        ...
        function obj_inv = inv(obj)
            ...
            g2 = inv(obj.g);
            v2 = -obj.CO_Ad_SE3_se3(g2,obj.v);
            v2 = round(v2,14);
            obj_inv = SE3_dse3(g2,v2);
        ...
        function [v,u] = log(obj)
            ...
            v = logm(obj.g);
            dv = SE3_dse3.se3_dexp_inv(v);
            u = SE3_dse3.SE3_wedge(dv*SE3_dse3.SE3_vee(obj.v));
